...
const AboutMe = () => {
  return (
    <div
      id="about"
      className="w-full px-[6%] md:px-[12%] py-10 scroll-mt-20 mt-10 md:mt-0"
    >
      <h4 className="text-center mb-2 text-lg font-Ovo">Introduction</h4>
      <h2 className="text-center text-5xl font-Ovo mb-4 md:mb-10">About me</h2>
      <div className="flex flex-col flex-1 items-center">
        ...
        <ul className="grid md:grid-cols-3 grid-cols-auto gap-6 max-w-4xl">
          ...
          <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 shadow-blackCustom">
            <img src="./images/edu-icon.png" className="w-7 mt-3 dark:hidden" />
        ...
        <ul className="flex items-center flex-wrap gap-3 sm:gap-5">
          ...
          <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
            <img src="./images/tailwind-css-icon.webp" className="w-7 sm:w-7" />
          </li>
          <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
